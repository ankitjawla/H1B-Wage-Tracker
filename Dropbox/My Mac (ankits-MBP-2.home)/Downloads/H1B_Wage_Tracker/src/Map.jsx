  ...
  useEffect(() => {
    ...
    map.on("load", async () => {
      ...
      map.on("click", "county-fill", (e) => {
        ...
        const color = levelColors[level] || "#F3F4F6";
        const levelName = levelNames[level] || "Below Level I";

        new mapboxgl.Popup({ maxWidth: "300px" })
          .setLngLat(e.lngLat)
          .setHTML(
            `<div style="padding: 4px;">
              <strong style="font-size: 16px; color: #111827;">${f.properties.NAME}, ${state}</strong><br/>
        ...
        {!collapsed && (
          <>
            ...
            <div className="stats-panel">
              ...
              <div className="stats-grid">
                <div className="stat-item">
                  <div className="stat-value" style={{ color: "#FEF3C7" }}>
                    {stats.level1}
                  </div>
                ...
                <div className="stat-item">
                  <div className="stat-value" style={{ color: "#4C1D95" }}>
                    {stats.level4}
                  </div>
            ...
            <div className="credit">
              Created by{" "}
              <a href="https://github.com/ankitjawla" target="_blank" rel="noopener noreferrer">
